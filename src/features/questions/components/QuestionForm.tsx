    ...
    >
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-lg">Important Interview Points</CardTitle>
          <Button
            type="button"
            variant="outline"
            size="sm"
            ...
            {formData.importantPoints.map((point, index) => (
              <div key={index} className="flex gap-2">
                <Input
                  value={point}
                  onChange={(e) =>
                    handleArrayChange("importantPoints", index, e.target.value)
                  }
                ...
                {formData.importantPoints.length > 1 && (
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    onClick={() => handleArrayRemove("importantPoints", index)}
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
            Additional questions interviewers might ask after the main question
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
            Keywords for filtering and search (e.g., hooks, async, performance,
            css-grid)
          </p>
        </CardContent>
      </Card>
